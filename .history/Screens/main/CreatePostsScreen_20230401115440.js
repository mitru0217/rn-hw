...
const CreatePostsScreen = ({ navigation }) => {
  ...
  //Создаём состояние для получения координат
    ...
    if (cameraRef.current && !isTakingPicture) {
      ...
      try {
        ...
        const response = await Axios.get(
          ...
          // "https://api.opencagedata.com/geocode/v1/json?q=51.0361102+29.2962951&key=2bcd8a72cefe47e4b387060ed1e39d39"
        );
          ...
          <View style={styles.inputViewLocation}>
            <TextInput
              ...
              onChangeText={(locality) =>
                setState((prevState) => ({ ...prevState, locality: locality }))
              }
            />
          </View>
        </KeyboardAvoidingView>
